    ...
    return (
        <div className="homePage">
            ...
            <div className="fallSemester">
                <p style={{margin: "1rem 0"}}>2024 FALL SEMESTER</p>
                <p className="fallSemesterText glacial">Registration for the fall semester starts on Aug 4 and will end on Aug 18.</p>
            ...
            <p className="classesForFall">CLASSES FOR FALL 2024</p>
            <div className="homeLinksGrid">
                ...
                <Link to={"/chess"} className="homeLink">
                    <div className="biblicalLink">
                        <img src={chess} alt=""></img>
                        <p style={{top: "45%", lineHeight: "normal"}} className="homeLinkTitles">CHESS</p>
                    </div>
                </Link>
            </div>
            <div style={{display: "relative", margin: "10vh 0"}}>
                <div className="classScheduleBanner">
                    <p>Classes are held every Saturday except Remnant Day (Last Saturday of every month) from 9/14 to 1/18</p>
                </div>
            </div>
            {/* <Footer/> */}
        </div>
